...
class ReinforceAgent(nn.Module):
    def __init__(self, state_dim, n_actions):
        ...
        self.fc_1 = nn.Linear(state_dim[0], 42)
        self.fc_2 = nn.Linear(42, n_actions)
...
# < YOUR CODE HERE >
def train_on_session(optimizer, states, actions, rewards, gamma=0.999):
    """
